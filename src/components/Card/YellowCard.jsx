...
export default function YellowCard({ props }) {
  ...
  return (
    <div className={`bg-gradient-to-tr from-yellow-500 to-yellow-700 p-6 rounded-2xl shadow-xl flex flex-col ${hoverClass}`}>
      ...
      <div className="flex flex-col md:flex-row gap-4 flex-1">
        ...
        <div className="flex flex-col flex-1 justify-between">
          <p className="text-gray-900 mb-4">{props.body}</p>
