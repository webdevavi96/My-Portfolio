...
export default function OrangeCard({ props }) {
  // Apply hover only if no img or link is passed
  const hoverClass = !props.img && !props.link ? "hover:scale-105 transform transition duration-300" : ""

  return (
    <div
      className={`bg-gradient-to-tr from-orange-500 to-orange-700 p-6 rounded-2xl shadow-xl flex flex-col ${hoverClass}`}
    >
      ...
      <div className="flex flex-col md:flex-row gap-4 flex-1">
        ...
        <div className="flex flex-col flex-1 justify-between">
          <p className="text-white mb-4">{props.body}</p>
